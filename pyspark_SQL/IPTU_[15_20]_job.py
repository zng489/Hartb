...
spark_frame = spark_frame.filter(col ('ANO_DO_EXERCICIO').isin(['2015', '2016', '2017', '2018', '2019', '2020']) )
...
IPTU_TOTAL_FINAL.write.format("parquet").mode("overwrite").option("header", "true").option("compression", "snappy").save("s3://bossa-nova-trusted/IPTU_15_20/")