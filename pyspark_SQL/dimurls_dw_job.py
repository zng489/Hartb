...
S3bucket_node1 = glueContext.create_dynamic_frame.from_catalog(
    database="db-test", table_name="dimurls", transformation_ctx="S3bucket_node1"
)
...
ApplyMapping_node2 = ApplyMapping.apply(
    ...
    mappings=[
        ...
        ("url_cd", "string", "url_cd", "string"),
        ("url", "string", "url", "string"),
        ("url_group", "string", "url_group", "string"),
        ("url_subgroup", "string", "url_subgroup", "string"),
    ],
